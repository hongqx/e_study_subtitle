...
requirejs.config({
    paths: {
      peaks: 'http://10.10.151.24:3003/build/threeParty/peaks.min',
      jquery: "http://10.10.151.24:3003/build/threeParty/jquery-2.1.4.min",
      segmentPart: 'http://10.10.151.24:3003/build/js/segmentPart.min',
      mCustomScrollbar : "http://10.10.151.24:3003/build/threeParty/jquery.mCustomScrollbar.concat.min",
      subtitleAxis:"http://10.10.151.24:3003/build/js/subtitleAxis.min"
    }
});
var Control ;
require(["jquery","segmentPart","subtitleAxis",'mCustomScrollbar'], function(jquery,segmentPart,subtitleAxis,mCustomScrollbar) {
