...
var Konva=require("konva"),mixins=require("peaks/waveform/waveform.mixins"),SegmentShape=require("peaks/markers/shapes/rect");module.exports=function(e){var t=this;t.segments=[],t.views=[e.waveform.waveformZoomView].map(function(e){return e.segmentLayer||(e.segmentLayer=new Konva.Layer,e.stage.add(e.segmentLayer),e.segmentLayer.moveToTop()),e}),this.checkPosition=function(e,t){var i=this.segments.length,r=0,n=-1;if(null===e&&null!==t){for(var r=t+1;r<i;r++)this.segments[r].index=r-1;return null}if(e.index)n=t;else for(;r<i;r++)if(!(e.startTime>=this.segments[r].endTime)){n=r;break}for(n<0&&(n=i),console.log("the position insert is "+n),e.index=n,this.segments.splice(n,0,e),r=n+1,i=this.segments.length;r<i;r++)this.segments[r].index=r;return e};var i=function(i,r,s,d,f,v,h,w){var g={id:i,segmentId:r,startTime:s,endTime:d,labelText:h||"",color:v||m(),editable:f},l=new Konva.Group,u=[l],T=function(e){this.parent.label.show(),this.parent.view.segmentLayer.draw()},c=function(e){this.parent.label.hide(),this.parent.view.segmentLayer.draw()};return u.forEach(function(i,r){var m=t.views[r];if(i.waveformShape=SegmentShape.createShape(g,m),i.waveformShape.on("mouseenter",T),i.waveformShape.on("mouseleave",c),i.add(i.waveformShape),i.label=new e.options.segmentLabelDraw(i,g),i.add(i.label.hide()),f){var s=!0;i.inMarker=new e.options.segmentInMarker(s,i,g,w,a,o,n),i.add(i.inMarker),i.outMarker=new e.options.segmentOutMarker(s,i,g,w,a,o,n),i.add(i.outMarker)}m.segmentLayer.add(i)}),g.zoom=l,g.zoom.view=e.waveform.waveformZoomView,g},r=function(t){e.waveform.waveformZoomView.data.set_segment(e.waveform.waveformZoomView.data.at_time(t.startTime),e.waveform.waveformZoomView.data.at_time(t.endTime),t.id);var i=e.waveform.waveformZoomView.data.at_time(t.startTime),r=e.waveform.waveformZoomView.data.at_time(t.endTime),n=e.waveform.waveformZoomView.frameOffset,a=e.waveform.waveformZoomView.frameOffset+e.waveform.waveformZoomView.width;if(i<n&&(i=n),r>a&&(r=a),e.waveform.waveformZoomView.data.segments[t.id].visible){var o=i-n,m=r-n;t.zoom.show(),t.editable&&(t.zoom.inMarker&&t.zoom.inMarker.show().setX(o-t.zoom.inMarker.getWidth()),t.zoom.outMarker&&t.zoom.outMarker.show().setX(m),t.zoom.inMarker.label.setText(mixins.niceTime(t.startTime,!1)),t.zoom.outMarker.label.setText(mixins.niceTime(t.endTime,!1))),SegmentShape.update.call(t.zoom.waveformShape,e.waveform.waveformZoomView,t.id)}else t.zoom.hide()},n=function(t,i,r){i.pStartTime=i.startTime,i.pEndTime=i.endTime,console.log("dragstart：segment.startTime:"+i.startTime+"  segment.endTime："+i.endTime),e.emit("segments.dragstart",i)},a=function(t,i,n){if(t.inMarker.getX()>0){var a=t.view.frameOffset+t.inMarker.getX()+t.inMarker.getWidth();i.startTime=t.view.data.time(a)}if(t.outMarker.getX()<t.view.width){var o=t.view.frameOffset+t.outMarker.getX();i.endTime=t.view.data.time(o)}e.emit("segments.dragmove",i),r(i),this.render()}.bind(this),o=function(t,i,n){var a=i.index;console.log("segment.startTime:"+i.startTime+"  segment.endTime："+i.endTime);var o=0;i.endTime-i.startTime<1&&(i.endTime!==i.pEndTime?(i.endTime=i.startTime+1,o=1):i.startTime!==i.pStartTime&&(i.startTime=i.endTime-1,o=1)),a>0&&i.startTime<n[a-1].endTime&&(o=1,console.log("开始时间小于相邻的开始时间"),i.startTime=n[a-1].endTime),a<n.length-1&&i.endTime>n[a+1].startTime&&(o=1,console.log("结束时间大于相邻的结束时间"),i.endTime=n[a+1].startTime),i.pStartTime=i.startTime,i.pEndTime=i.endTime,e.emit("segments.dragend",i),1===o&&(r(i),this.render())}.bind(this),m=function(){var t;if(e.options.randomizeSegmentColor){var i=function(){return Math.floor(255*Math.random())};t="rgba("+i()+", "+i()+", "+i()+", 1)"}else t=e.options.segmentColor;return t};this.init=function(){e.on("waveform_zoom_displaying",this.updateSegments.bind(this)),e.emit("segments.ready")},this.updateSegments=function(){this.segments.forEach(r),this.render(),e.emit("segments.ok")},this.createSegment=function(e,n,a,o,m,s){var d="segment"+t.segments.length;if(n>=0==!1)throw new TypeError("[waveform.segments.createSegment] startTime should be a positive value");if(a>0==!1)throw new TypeError("[waveform.segments.createSegment] endTime should be a positive value");if(a>n==!1)throw new RangeError("[waveform.segments.createSegment] endTime should be higher than startTime");var f=this.segments,v=i(d,e,n,a,o,m,s,f);return this.checkPosition(v),r(v),v},this.remove=function(e){var t=null;return this.segments.some(function(i,r){if(i===e)return t=r,!0}),"number"==typeof t&&(e=this.segments[t],e.zoom.destroy()),this.checkPosition(null,t),t},this.removeAll=function(){this.views.forEach(function(e){e.segmentLayer.removeChildren()}),this.segments=[],this.render()},this.render=function(){this.views.forEach(function(e){e.segmentLayer.draw()})}};
