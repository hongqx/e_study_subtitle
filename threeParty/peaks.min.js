...
var Konva=require("konva"),mixins=require("peaks/waveform/waveform.mixins"),SegmentShape=require("peaks/markers/shapes/rect");module.exports=function(e){var t=this;t.segments=[],t.views=[e.waveform.waveformZoomView].map(function(e){return e.segmentLayer||(e.segmentLayer=new Konva.Layer,e.stage.add(e.segmentLayer),e.segmentLayer.moveToTop()),e}),this.checkPosition=function(e,t){var r=this.segments.length,i=0,a=-1;if(null===e&&null!==t){for(var i=t+1;i<r;i++)this.segments[i].index=i-1;return null}if(e.index)a=t;else for(;i<r;i++)if(!(e.startTime>=this.segments[i].endTime)){a=i;break}for(a<0&&(a=r),console.log("the position insert is "+a),e.index=a,this.segments.splice(a,0,e),i=a+1,r=this.segments.length;i<r;i++)this.segments[i].index=i;return e};var r=function(r,i,s,h,d,w,f,v){var g={id:r,segmentId:i,startTime:s,endTime:h,labelText:f||"",color:w||m(),editable:d},u=new Konva.Group,l=[u],c=function(e){this.parent.label.show(),this.parent.view.segmentLayer.draw()},T=function(e){this.parent.label.hide(),this.parent.view.segmentLayer.draw()},p=function(r){t.showMarkerView&&t.showMarkerView.parent&&(t.showMarkerView.parent.inMarker.children[2].hide(),t.showMarkerView.parent.outMarker.children[2].hide(),t.showMarkerView.parent.view.segmentLayer.draw()),this.parent.inMarker.children[2].show(),this.parent.outMarker.children[2].show(),this.parent.view.segmentLayer.draw(),t.showMarkerView=this,e.emit("segment.click",g)};return l.forEach(function(r,i){var m=t.views[i];r.waveformShape=SegmentShape.createShape(g,m),r.waveformShape.on("mouseover",c),r.waveformShape.on("mouseleave",T),r.waveformShape.on("click",p),r.add(r.waveformShape),r.label=new e.options.segmentLabelDraw(r,g),r.add(r.label.hide());var s=!0;r.inMarker=new e.options.segmentInMarker(s,r,g,v,n,o,a),r.inMarker.children[2].hide(),r.add(r.inMarker),r.outMarker=new e.options.segmentOutMarker(s,r,g,v,n,o,a),r.outMarker.children[2].hide(),r.add(r.outMarker),m.segmentLayer.add(r)}),g.zoom=u,g.zoom.view=e.waveform.waveformZoomView,g},i=function(t){e.waveform.waveformZoomView.data.set_segment(e.waveform.waveformZoomView.data.at_time(t.startTime),e.waveform.waveformZoomView.data.at_time(t.endTime),t.id);var r=e.waveform.waveformZoomView.data.at_time(t.startTime),i=e.waveform.waveformZoomView.data.at_time(t.endTime),a=e.waveform.waveformZoomView.frameOffset,n=e.waveform.waveformZoomView.frameOffset+e.waveform.waveformZoomView.width;if(r<a&&(r=a),i>n&&(i=n),e.waveform.waveformZoomView.data.segments[t.id].visible){var o=r-a,m=i-a;t.zoom.show(),t.editable&&(t.zoom.inMarker&&t.zoom.inMarker.setX(o-t.zoom.inMarker.getWidth()),t.zoom.outMarker&&t.zoom.outMarker.setX(m),t.zoom.inMarker.label.setText(mixins.niceTime(t.startTime,!1)),t.zoom.outMarker.label.setText(mixins.niceTime(t.endTime,!1))),SegmentShape.update.call(t.zoom.waveformShape,e.waveform.waveformZoomView,t.id)}else t.zoom.hide()},a=function(t,r,i){r.pStartTime=r.startTime,r.pEndTime=r.endTime,e.emit("segments.dragstart",r)},n=function(t,r,a){if(t.inMarker.getX()>0){var n=t.view.frameOffset+t.inMarker.getX()+t.inMarker.getWidth();r.startTime=t.view.data.time(n)}if(t.outMarker.getX()<t.view.width){var o=t.view.frameOffset+t.outMarker.getX();r.endTime=t.view.data.time(o)}e.emit("segments.dragmove",r),i(r),this.render()}.bind(this),o=function(t,r,a){var n=r.index,o=0;r.endTime-r.startTime<1&&(r.endTime!==r.pEndTime?(r.endTime=r.startTime+1,o=1):r.startTime!==r.pStartTime&&(r.startTime=r.endTime-1,o=1)),n>0&&r.startTime<a[n-1].endTime&&(o=1,r.startTime=a[n-1].endTime),n<a.length-1&&r.endTime>a[n+1].startTime&&(o=1,r.endTime=a[n+1].startTime),r.pStartTime=r.startTime,r.pEndTime=r.endTime,e.emit("segments.dragend",r),1===o&&(i(r),this.render())}.bind(this),m=function(){var t;if(e.options.randomizeSegmentColor){var r=function(){return Math.floor(255*Math.random())};t="rgba("+r()+", "+r()+", "+r()+", 1)"}else t=e.options.segmentColor;return t};this.init=function(){e.on("waveform_zoom_displaying",this.updateSegments.bind(this)),e.emit("segments.ready")},this.updateSegments=function(){this.segments.forEach(i),this.render()},this.createSegment=function(e,a,n,o,m,s){var h="segment"+t.segments.length;if(a>=0==!1)throw new TypeError("[waveform.segments.createSegment] startTime should be a positive value");if(n>0==!1)throw new TypeError("[waveform.segments.createSegment] endTime should be a positive value");if(n>a==!1)throw new RangeError("[waveform.segments.createSegment] endTime should be higher than startTime");var d=this.segments,w=r(h,e,a,n,o,m,s,d);return this.checkPosition(w),i(w),w},this.remove=function(e){var t=null;return this.segments.some(function(r,i){if(r===e)return t=i,!0}),"number"==typeof t&&(e=this.segments[t],e.zoom.destroy()),this.checkPosition(null,t),t},this.removeAll=function(){this.views.forEach(function(e){e.segmentLayer.removeChildren()}),this.segments=[],this.render()},this.render=function(){this.views.forEach(function(e){e.segmentLayer.draw()})}};
...
function createPointHandle(e,t){return function(n,r,o,a,i,u){var f=e/2-10.5,l=10,d=20,h=.5,s=new Konva.Group({draggable:n,dragBoundFunc:function(e){return{x:e.x,y:this.getAbsolutePosition().y}}}).on("dragmove",function(e){a(r,o)});i&&s.on("dblclick",function(e){i(o)}),u&&s.on("dragend",function(e){u(o)});var c=-l,v=new Konva.Text({x:c,y:e/2-5,text:"",fontSize:10,fontFamily:"sans-serif",fill:"#000",textAlign:"center"});v.hide(),s.label=v;var g=new Konva.Rect({width:l,height:d,fill:t,x:h,y:f}),w=new Konva.Line({points:[0,0,0,e],stroke:t,strokeWidth:1,x:h,y:0});return g.on("mouseover",function(e){v.show(),v.setX(c-v.getWidth()),r.view.pointLayer.draw()}),g.on("mouseout",function(e){v.hide(),r.view.pointLayer.draw()}),s.add(g),s.add(w),s.add(v),s}}function drawWaveform(e,t,n,r,o,a){e.beginPath(),t.forEach(function(t,n){e.lineTo(r+n+.5,a(t)+.5)}),n.reverse().forEach(function(t,n){e.lineTo(r+(o-n)+.5,a(t)+.5)}),e.closePath()}function interpolateHeightGenerator(e){var t=256;return function(n){return e-(n+128)*e/t}}var Konva=require("konva"),createHandle=function(e,t,n){return function(r,o,a,i,u,f,l){var d=30,h=10,s=e/2-10.5,c=.5,c=n?.5:-h,v=new Konva.Group({draggable:r,dragBoundFunc:function(e){var t;return n?(t=o.outMarker.getX()-o.outMarker.getWidth(),e.x>t&&(e.x=t)):(t=o.inMarker.getX()+o.inMarker.getWidth(),e.x<t&&(e.x=t)),{x:e.x,y:this.getAbsolutePosition().y}}}).on("dragmove",function(e){u(o,a,i)});f&&v.on("dragend",function(e){f(o,a,i)}),l&&v.on("dragstart",function(e){l(o,a,i)});var g=n?-24:24,w=new Konva.Text({x:g,y:e/2-5,text:"",fontSize:10,fontFamily:"sans-serif",fill:"#000",textAlign:"center"});w.hide(),v.label=w;var x=new Image;x.src="http://konvajs.github.io/assets/yoda.jpg";var m=new Konva.Rect({width:h,height:d,fill:t,stroke:t,strokeWidth:1,x:c,y:s,fillPatternImage:x}),k=new Konva.Line({points:[.5,0,.5,e],strokeWidth:1,stroke:t,x:0,y:0});return k.show(),m.on("mouseenter",function(e){n&&w.setX(g-w.getWidth()),k.show(),w.show(),o.view.segmentLayer.draw()}),m.on("mouseleave",function(e){k.show(),w.hide(),o.view.segmentLayer.draw()}),v.add(w),v.add(k),v.add(m),v}};module.exports={interpolateHeight:interpolateHeightGenerator,drawWaveform:drawWaveform,waveformDrawFunction:function(e,t){var n=e.intermediateData||e.data,r=interpolateHeightGenerator(e.height),o=n.offset_length;drawWaveform(t,n.min,n.max,0,o,r),t.fillStrokeShape(this)},waveformOverviewMarkerDrawFunction:function(e,t,n){t.waveformShape.setPoints([e,0,e,n.height])},niceTime:function(e,t){var n,r,o,a,i=[];n=Math.floor(e%1*100),r=Math.floor(e),o=Math.floor(r/60),a=Math.floor(o/60),a>0&&i.push(a),i.push(o%60),i.push(r%60);for(var u=0;u<i.length;u++){var f=i[u];f<10?i[u]="0"+f:i[u]=f}return i=i.join(":"),t||(n<10&&(n="0"+n),i+="."+n),i},defaultInMarker:function(e){return createHandle(e.height,e.inMarkerColor,!0)},defaultOutMarker:function(e){return createHandle(e.height,e.outMarkerColor,!1)},defaultPointMarker:function(e){return createPointHandle(e.height,e.pointMarkerColor)},defaultSegmentLabelDraw:function(e){return function(e,t){return new Konva.Text({x:12,y:12,text:t.labelText,fontSize:12,fontFamily:"Arial, sans-serif",fill:"#000",textAlign:"center"})}}};
},{"konva":5}]},{},[15])(15)
});
