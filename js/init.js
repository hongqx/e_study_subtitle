requirejs.config({
    paths: {
      peaks: 'http://10.10.151.76:3002/threeParty/peaks',
      jquery: "http://10.10.151.76:3002/threeParty/jquery-2.1.4.min",
      utility: 'http://10.10.151.76:3002/js/utility',
      segmentPart: 'http://10.10.151.76:3002/js/segmentPart',
      mCustomScrollbar : "http://10.10.151.76:3002/threeParty/jquery.mCustomScrollbar.concat.min",
      localstorage:"http://10.10.151.76:3002/js/localstorage",
      videoPlayer:"http://10.10.151.76:3002/js/videoPlayer",
      videoInfo:"http://10.10.151.76:3002/js/videoInfo",
      subtitleAxis:"http://10.10.151.76:3002/js/subtitleAxis"
    }
});
var Control ;
