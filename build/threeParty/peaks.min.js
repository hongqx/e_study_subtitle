...
var BaseShape=require("peaks/markers/shapes/base"),mixins=require("peaks/waveform/waveform.mixins"),Konva=require("konva"),WaveShape=Object.create(BaseShape.prototype);WaveShape.createShape=function(e,a){var t=new Konva.Rect({fill:e.color,strokeWidth:0,y:0,x:0,width:0,height:a.height,opacity:.7});return t},WaveShape.update=function(e,a,t){var r=e.data;if(void 0!==r.segments[a]){var s=r.segments[a],i=s.offset_length,o=s.offset_start-r.offset_start,t=t;this.setAttrs({x:o,width:i,fill:t})}},module.exports=WaveShape;
...
var Konva=require("konva"),mixins=require("peaks/waveform/waveform.mixins"),SegmentShape=require("peaks/markers/shapes/rect");module.exports=function(e){var t=this;t.segments=[],t.views=[e.waveform.waveformZoomView].map(function(e){return e.segmentLayer||(e.segmentLayer=new Konva.Layer,e.stage.add(e.segmentLayer),e.segmentLayer.moveToTop()),e}),this.checkPosition=function(e,t){var r=this.segments.length,i=0,n=-1;if(null===e&&null!==t){for(var i=t+1;i<r;i++)this.segments[i].index=i-1;return null}if(e.index)n=t;else for(;i<r;i++)if(!(e.startTime>=this.segments[i].endTime)){n=i;break}for(n<0&&(n=r),e.index=n,this.segments.splice(n,0,e),i=n+1,r=this.segments.length;i<r;i++)this.segments[i].index=i;return e};var r=function(r,i,s,h,d,g,f,w){var v={id:r,segmentId:i,startTime:s,endTime:h,labelText:f||"",color:g||o(),editable:d},l=new Konva.Group,u=[l],c=function(e){this.parent.label.show(),this.parent.view.segmentLayer.draw()},T=function(e){this.parent.label.hide(),this.parent.view.segmentLayer.draw()},p=function(r){this.parent!==t.segment&&(t.segment&&t.segment.inMarker.children.length>0&&(t.segment.inMarker.children[2].hide(),t.segment.outMarker.children[2].hide(),t.segment.view.segmentLayer.draw()),this.parent.inMarker.children[2].show(),this.parent.outMarker.children[2].show(),this.parent.view.segmentLayer.draw(),t.segment=this.parent,e.emit("segment.click",v))},k=function(e){t.segment!==e&&(t.segment&&t.segment.inMarker.children.length&&(t.segment.inMarker.children[2].hide(),t.segment.outMarker.children[2].hide(),t.segment.view.segmentLayer.draw()),t.segment=e)};return u.forEach(function(r,i){var o=t.views[i];r.waveformShape=SegmentShape.createShape(v,o),r.waveformShape.on("mouseover",c),r.waveformShape.on("mouseleave",T),r.waveformShape.on("click",p),r.add(r.waveformShape),r.label=new e.options.segmentLabelDraw(r,v),r.add(r.label.hide());var s=!0;r.inMarker=new e.options.segmentInMarker(s,r,v,w,a,m,n),r.add(r.inMarker),r.outMarker=new e.options.segmentOutMarker(s,r,v,w,a,m,n),r.add(r.outMarker),o.segmentLayer.add(r),k(r)}),v.zoom=l,v.zoom.view=e.waveform.waveformZoomView,v},i=function(t){e.waveform.waveformZoomView.data.set_segment(e.waveform.waveformZoomView.data.at_time(t.startTime),e.waveform.waveformZoomView.data.at_time(t.endTime),t.id);var r=e.waveform.waveformZoomView.data.at_time(t.startTime),i=e.waveform.waveformZoomView.data.at_time(t.endTime),n=e.waveform.waveformZoomView.frameOffset,a=e.waveform.waveformZoomView.frameOffset+e.waveform.waveformZoomView.width;if(r<n&&(r=n),i>a&&(i=a),e.waveform.waveformZoomView.data.segments[t.id].visible){var m=r-n,o=i-n;t.zoom.show(),t.editable&&(t.zoom.inMarker&&t.zoom.inMarker.setX(m-t.zoom.inMarker.getWidth()),t.zoom.outMarker&&t.zoom.outMarker.setX(o),t.zoom.inMarker.label.setText(mixins.niceTime(t.startTime,!1)),t.zoom.outMarker.label.setText(mixins.niceTime(t.endTime,!1))),SegmentShape.update.call(t.zoom.waveformShape,e.waveform.waveformZoomView,t.id)}else t.zoom.hide()},n=function(t,r,i){r.pStartTime=r.startTime,r.pEndTime=r.endTime,e.emit("segments.dragstart",r)},a=function(t,r,n){if(t.inMarker.getX()>0){var a=t.view.frameOffset+t.inMarker.getX()+t.inMarker.getWidth();r.startTime=Number(t.view.data.time(a).toFixed(2))}if(t.outMarker.getX()<t.view.width){var m=t.view.frameOffset+t.outMarker.getX();r.endTime=Number(t.view.data.time(m).toFixed(2))}e.emit("segments.dragmove",r),i(r),this.render()}.bind(this),m=function(t,r,n){var a=r.index,m=0;r.endTime-r.startTime<1&&(r.endTime!==r.pEndTime?(r.endTime=r.startTime+1,m=1):r.startTime!==r.pStartTime&&(r.startTime=r.endTime-1,m=1)),a>0&&r.startTime<n[a-1].endTime&&(m=1,r.startTime=n[a-1].endTime),a<n.length-1&&r.endTime>n[a+1].startTime&&(m=1,r.endTime=n[a+1].startTime),r.pStartTime=r.startTime,r.pEndTime=r.endTime,e.emit("segments.dragend",r),1===m&&(i(r),this.render())}.bind(this),o=function(){var t;if(e.options.randomizeSegmentColor){var r=function(){return Math.floor(255*Math.random())};t="rgba("+r()+", "+r()+", "+r()+", 1)"}else t=e.options.segmentColor;return t};this.init=function(){e.on("waveform_zoom_displaying",this.updateSegments.bind(this)),e.emit("segments.ready")},this.updateSegments=function(){this.segments.forEach(i),this.render()},this.createSegment=function(e,n,a,m,o,s){var h="segment"+t.segments.length;if(n>=0==!1)throw new TypeError("[waveform.segments.createSegment] startTime should be a positive value");if(a>0==!1)throw new TypeError("[waveform.segments.createSegment] endTime should be a positive value");if(a>n==!1)throw new RangeError("[waveform.segments.createSegment] endTime should be higher than startTime");var d=this.segments,g=r(h,e,n,a,m,o,s,d);return this.checkPosition(g),i(g),g},this.remove=function(e){var t=null;return this.segments.some(function(r,i){if(r===e)return t=i,!0}),"number"==typeof t&&(e=this.segments[t],e.zoom.destroy()),this.checkPosition(null,t),t},this.removeAll=function(){this.views.forEach(function(e){e.segmentLayer.removeChildren()}),this.segments=[],this.render()},this.changeMarker=function(e){if(!e||!e.zoom||t.segment!==e.zoom){if(this.segment&&this.segment.inMarker.children.length&&(this.segment.inMarker.children[2].hide(),this.segment.outMarker.children[2].hide(),this.segment.view.segmentLayer.draw()),!e||!e.zoom)return void(this.segment=null);e.zoom.inMarker.children[2].show(),e.zoom.outMarker.children[2].show(),e.zoom.view.segmentLayer.draw(),this.segment=e.zoom}},this.render=function(){this.views.forEach(function(e){e.segmentLayer.draw()})}};
},{"konva":5,"peaks/markers/shapes/rect":17,"peaks/waveform/waveform.mixins":28}],20:[function(require,module,exports){
...
function WaveformOverview(e,t,a){function r(e,t){a.seeking||(i.playheadPixel=i.data.at_time(e),i.updateUi(i.playheadPixel))}var i=this;i.peaks=a,i.options=a.options,i.data=e,i.width=t.clientWidth,i.height=t.clientHeight||i.options.height,i.frameOffset=0,i.stage=new Konva.Stage({container:t,width:i.width,height:i.height}),i.waveformLayer=new Konva.Layer,i.background=new Konva.Rect({x:0,y:11,width:i.width,height:i.height-22}),i.waveformLayer.add(i.background),i.createWaveform(),i.createRefWaveform(),i.createUi();var o=function(){i.stage.off("mousemove mouseup"),a.seeking=!1};i.stage.on("mousedown",function(e){!e.target||e.target.attrs.draggable||e.target.parent.attrs.draggable||("mousedown"==e.type?(a.seeking=!0,a.emit("user_seek.overview",i.data.time(e.evt.layerX),e.evt.layerX),i.stage.on("mousemove",function(e){a.emit("user_scrub.overview",i.data.time(e.evt.layerX),e.evt.layerX)}),i.stage.on("mouseup",o)):o())}),a.on("player_time_update",r),a.on("user_seek.*",r),a.on("user_scrub.*",r),a.on("waveform_zoom_displaying",function(e,t){i.updateRefWaveform(e,t)}),a.on("resizeEndOverview",function(e,t){i.width=e,i.data=t,i.stage.setWidth(i.width),a.emit("overview_resized")})}var WaveformAxis=require("peaks/waveform/waveform.axis"),mixins=require("peaks/waveform/waveform.mixins"),Konva=require("konva");WaveformOverview.prototype.createWaveform=function(){var e=this;this.waveformShape=new Konva.Shape({fill:e.options.overviewWaveformColor,strokeWidth:0}),this.waveformShape.sceneFunc(mixins.waveformDrawFunction.bind(this.waveformShape,e)),this.waveformLayer.add(this.waveformShape),this.stage.add(this.waveformLayer)},WaveformOverview.prototype.createRefWaveform=function(){var e=this;this.refLayer=new Konva.Layer,this.refWaveformRect=new Konva.Rect({x:0,y:0,width:0,stroke:e.options.overviewHighlightRectangleColor,strokeWidth:3,height:this.height,fill:e.options.overviewHighlightRectangleColor,opacity:.5,cornerRadius:2}),this.refLayer.add(this.refWaveformRect),this.stage.add(this.refLayer)},WaveformOverview.prototype.createUi=function(){var e=this;this.playheadLine=new Konva.Line({points:[.5,0,.5,e.height],stroke:e.options.playheadColor,strokeWidth:1.5,x:0}),e.uiLayer=new Konva.Layer({index:100}),e.axis=new WaveformAxis(e),this.uiLayer.add(this.playheadLine),this.stage.add(this.uiLayer),this.uiLayer.moveToTop()},WaveformOverview.prototype.updateRefWaveform=function(e,t){if(isNaN(e))throw new Error("WaveformOverview#updateRefWaveform passed a time in that is not a number: "+e);if(isNaN(t))throw new Error("WaveformOverview#updateRefWaveform passed a time out that is not a number: "+t);var a=this,r=a.data.at_time(e),i=a.data.at_time(t);a.data.set_segment(r,i,"zoom"),a.refWaveformRect.setAttrs({x:a.data.segments.zoom.offset_start-a.data.offset_start,width:a.data.at_time(t)-a.data.at_time(e)}),a.refLayer.draw()},WaveformOverview.prototype.updateUi=function(e){if(isNaN(e))throw new Error("WaveformOverview#updateUi passed a value that is not a number: "+e);var t=this;t.playheadLine.setAttr("x",e),t.uiLayer.draw()},module.exports=WaveformOverview;
},{"konva":5,"peaks/waveform/waveform.axis":26,"peaks/waveform/waveform.mixins":28}],23:[function(require,module,exports){
function WaveformZoomView(e,a,o){var t=this;t.cur_scale=0,t.peaks=o,t.options=o.options,t.rootData=e,t.playing=!1,t.intermediateData=null,t.data=t.rootData.resample({scale:t.options.zoomLevels[o.zoom.getZoom()]}),t.playheadPixel=t.data.at_time(t.options.mediaElement.currentTime),t.pixelLength=t.data.adapter.length,t.frameOffset=0,t.width=a.clientWidth,t.height=a.clientHeight||t.options.height,t.data.offset(t.frameOffset,t.frameOffset+t.width),t.stage=new Konva.Stage({container:a,width:t.width,height:t.height}),t.zoomWaveformLayer=new Konva.Layer,t.uiLayer=new Konva.Layer,t.background=new Konva.Rect({x:0,y:0,width:t.width,height:t.height}),t.zoomWaveformLayer.add(t.background),t.axis=new WaveformAxis(t,1),t.createZoomWaveform(),t.createUi(),t.stage.on("mousedown",function(e){if(e.target&&!e.target.attrs.draggable&&!e.target.parent.attrs.draggable&&"mousedown"===e.type){var a,i,r=e.evt.layerX;o.seeking=!0,t.stage.on("mousemove",function(e){o.seeking=!1,a=e.evt.layerX>r?r-e.evt.layerX:1*(r-e.evt.layerX),r=e.evt.layerX,i=t.frameOffset+a,i=i<0?0:i>t.pixelLength-t.width?t.pixelLength-t.width:i,t.updateZoomWaveform(i)}),t.stage.on("mouseup",function(){o.seeking&&t.peaks.emit("user_seek.zoomview",t.data.time(t.frameOffset+r),t.frameOffset+r),t.stage.off("mousemove mouseup"),o.seeking=!1})}}),t.stage.on("dblclick",function(e){t.peaks.emit("zoomviewdblclick")}),t.stage.on("click",function(e){t.peaks.emit("zoomviewclick")});var i=function(e,a){e=e||{withOffset:!0};var o=t.data.at_time(a);t.seekFrame(o,e.withOffset?Math.round(t.width/2):0),t.playing&&t.playFrom(a,o)};t.peaks.on("player_time_update",function(e){o.seeking||t.seekFrame(t.data.at_time(e))}),t.peaks.on("player_seek",i.bind(null,{withOffset:!0})),t.peaks.on("user_seek.*",i.bind(null,{withOffset:!0})),t.peaks.on("user_scrub.*",i.bind(null,{withOffset:!1})),t.peaks.on("player_play",function(e){t.playing=!0,t.playFrom(e,t.data.at_time(e))}),t.peaks.on("player_pause",function(e){t.playing=!1,t.playheadLineAnimation&&t.playheadLineAnimation.stop(),t.syncPlayhead(t.data.at_time(e))}),t.peaks.on("zoom.update",function(e,a){var o,i;if(!t.playing&&e!==a){if(t.data=t.rootData.resample({scale:e}),i={animated:AnimatedZoomAdapter,static:StaticZoomAdapter},void 0===i[t.peaks.options.zoomAdapter])throw new Error("Invalid zoomAdapter: "+t.peaks.options.zoomAdapter);o=i[t.peaks.options.zoomAdapter].init(e,a,t),o.start()}}),t.peaks.on("window_resized",function(e,a){t.width=e,t.data=a,t.stage.setWidth(t.width),t.updateZoomWaveform(t.frameOffset),t.peaks.emit("zoomview_resized")});var r=function(e){var a=t.options.mediaElement.currentTime;a+=t.options.nudgeIncrement*e,t.seekFrame(t.data.at_time(a))};t.peaks.on("kybrd_left",r.bind(t,-1)),t.peaks.on("kybrd_right",r.bind(t,1)),t.peaks.on("kybrd_shift_left",r.bind(t,-10)),t.peaks.on("kybrd_shift_right",r.bind(t,10))}var WaveformAxis=require("peaks/waveform/waveform.axis"),mixins=require("peaks/waveform/waveform.mixins"),AnimatedZoomAdapter=require("peaks/views/zooms/animated"),StaticZoomAdapter=require("peaks/views/zooms/static"),Konva=require("konva");WaveformZoomView.prototype.createZoomWaveform=function(){var e=this;e.zoomWaveformShape=new Konva.Shape({fill:e.options.zoomWaveformColor,strokeWidth:0}),e.zoomWaveformShape.sceneFunc(mixins.waveformDrawFunction.bind(e.zoomWaveformShape,e)),e.zoomWaveformLayer.add(e.zoomWaveformShape),e.stage.add(e.zoomWaveformLayer),e.peaks.emit("waveform_zoom_displaying",0*e.data.seconds_per_pixel,e.width*e.data.seconds_per_pixel)},WaveformZoomView.prototype.createUi=function(){var e=this;e.zoomPlayheadLine=new Konva.Line({points:[.5,0,.5,e.height],stroke:e.options.playheadColor,strokeWidth:1.5}),e.zoomPlayheadText=new Konva.Text({x:2,y:20,text:"00:00:00",fontSize:11,fontFamily:"sans-serif",fill:e.options.playheadTextColor,align:"right"}),e.zoomPlayheadGroup=new Konva.Group({x:0,y:0}).add(e.zoomPlayheadLine).add(e.zoomPlayheadText),e.uiLayer.add(e.zoomPlayheadGroup),e.stage.add(e.uiLayer),e.zoomPlayheadGroup.moveToTop()},WaveformZoomView.prototype.updateZoomWaveform=function(e){if(isNaN(e))throw new Error("WaveformZoomView#updateZoomWaveform passed a pixel offset that is not a number: "+e);var a=this;a.pixelLength=a.data.adapter.length,a.pixelLength<a.width&&(e=0),e>a.pixelLength&&(e=a.pixelLength-a.width),e<0&&(e=0),a.frameOffset=e,a.data.offset(e,Math.min(e+a.width,a.pixelLength));var o=a.playheadPixel>=e&&a.playheadPixel<=e+a.width;if(o){var t=a.playheadPixel-e;a.zoomPlayheadGroup.show().setAttr("x",t),a.zoomPlayheadText.setText(mixins.niceTime(a.data.time(a.playheadPixel),!1))}else a.zoomPlayheadGroup.hide();a.uiLayer.draw(),a.zoomWaveformLayer.draw(),a.peaks.emit("waveform_zoom_displaying",e*a.data.seconds_per_pixel,(e+a.width)*a.data.seconds_per_pixel)},WaveformZoomView.prototype.playFrom=function(e,a){var o=this;o.playheadLineAnimation&&o.playheadLineAnimation.stop();var t=0,i=o.data.pixels_per_second;o.playheadLineAnimation=new Konva.Animation(function(e){var r=e.time,n=r/1e3,s=Math.round(a-o.frameOffset+i*(n-t));o.syncPlayhead(o.frameOffset+s)},o.uiLayer),o.playheadLineAnimation.start()},WaveformZoomView.prototype.newFrame=function(e){if(isNaN(e))throw new Error("WaveformZoomView#newFrame passed a frame offset that is not a number: "+e);var a=e+this.width;return a<this.data.adapter.length&&(this.frameOffset=a,this.updateZoomWaveform(a),!0)},WaveformZoomView.prototype.syncPlayhead=function(e){if(isNaN(e))throw new Error("WaveformZoomView#syncPlayhead passed a pixel index that is not a number: "+e);var a=this,o=e>=a.frameOffset&&e<=a.frameOffset+a.width;if(a.playheadPixel=e,o){var t=a.playheadPixel-a.frameOffset;a.zoomPlayheadGroup.show().setAttr("x",t),a.zoomPlayheadText.setText(mixins.niceTime(a.data.time(a.playheadPixel),!1))}else a.zoomPlayheadGroup.hide();a.uiLayer.draw()},WaveformZoomView.prototype.seekFrame=function(e,a){if(isNaN(e))throw new Error("WaveformZoomView#seekFrame passed a pixel index that is not a number: "+e);var o=this,t=o.data.adapter.length-o.width;e<o.data.offset_start?"backwards":"onwards";o.data.in_offset(e)||(o.frameOffset=e-Math.round(o.width/2),o.frameOffset<=0?o.frameOffset=0:o.frameOffset+o.width>=o.data.adapter.length&&(o.frameOffset=t)),o.syncPlayhead(e),o.updateZoomWaveform(o.frameOffset)},module.exports=WaveformZoomView;
...
function roundUpToNearest(t,e){var i=t%e;return 0===i?t:t+e-i}function WaveformAxis(t,e){this.view=t,this.type=e||0,this.axisShape=new Konva.Shape({fill:"rgba(38, 255, 161, 1)",strokeWidth:0,opacity:1}),this.axisShape.sceneFunc(this.axisDrawFunction.bind(this,t)),this.view.uiLayer.add(this.axisShape)}var mixins=require("peaks/waveform/waveform.mixins"),Konva=require("konva");WaveformAxis.prototype.getAxisLabelScale=function(){for(var t,e=1,i=[1,2,5,10,20,30],a=1===this.type?20:60,s=0;;){t=e*i[s];var r=this.view.data.at_time(t);if(!(r<a))break;++s==i.length&&(e*=60,s=0)}return t},WaveformAxis.prototype.axisDrawFunction=function(t,e){var i=t.data.time(t.frameOffset),a=this.view.options.markerHeight||10,s=this.getAxisLabelScale(),r=roundUpToNearest(i,s),o=r-i,n=this.view.data.at_time(o);e.setAttr("strokeStyle",this.view.options.axisGridlineColor),e.setAttr("lineWidth",1),e.setAttr("font","11px sans-serif"),e.setAttr("fillStyle",this.view.options.axisLabelColor),e.setAttr("textAlign","left"),e.setAttr("textBaseline","bottom");for(var h,v=r;h=n+this.view.data.at_time(v-r),!(h>=this.view.width);){e.beginPath(),e.moveTo(h+.5,0),e.lineTo(h+.5,0+a),e.moveTo(h+.5,this.view.height),e.lineTo(h+.5,this.view.height-a),e.stroke();var l=mixins.niceTime(v,!0),x=e._context.measureText(l).width,f=h-x/2,m=this.view.height-1-a;f>=0&&e.fillText(l,f,m),v+=s}},module.exports=WaveformAxis;
...
function createPointHandle(e,t){return function(n,r,o,a,i,u){var f=e/2-10.5,l=10,d=20,h=.5,s=new Konva.Group({draggable:n,dragBoundFunc:function(e){return{x:e.x,y:this.getAbsolutePosition().y}}}).on("dragmove",function(e){a(r,o)});i&&s.on("dblclick",function(e){i(o)}),u&&s.on("dragend",function(e){u(o)});var c=-l,v=new Konva.Text({x:c,y:e/2-5,text:"",fontSize:20,fontFamily:"sans-serif",fill:"#000",textAlign:"center"});v.hide(),s.label=v;var g=new Konva.Rect({width:l,height:d,fill:t,x:h,y:f}),w=new Konva.Line({points:[0,0,0,e],stroke:t,strokeWidth:1,x:h,y:0});return g.on("mouseover",function(e){v.show(),v.setX(c-v.getWidth()),r.view.pointLayer.draw()}),g.on("mouseout",function(e){v.hide(),r.view.pointLayer.draw()}),s.add(g),s.add(w),s.add(v),s}}function drawWaveform(e,t,n,r,o,a){e.beginPath(),t.forEach(function(t,n){e.lineTo(r+n+1,a(t)+1)}),n.reverse().forEach(function(t,n){e.lineTo(r+(o-n)+1,a(t)+1)}),e.closePath()}function interpolateHeightGenerator(e){var t=512;return function(n){return e-(n+256)*e/t}}var Konva=require("konva"),createHandle=function(e,t,n,r){return function(o,a,i,u,f,l,d){var h=30,s=10,c=e/2-10.5,v=.5,v=n?.5:-s,g=new Konva.Group({draggable:o,dragBoundFunc:function(e){var t;return n?(t=a.outMarker.getX()-a.outMarker.getWidth(),e.x>t&&(e.x=t)):(t=a.inMarker.getX()+a.inMarker.getWidth(),e.x<t&&(e.x=t)),{x:e.x,y:this.getAbsolutePosition().y}}}).on("dragmove",function(e){f(a,i,u)});l&&g.on("dragend",function(e){l(a,i,u)}),d&&g.on("dragstart",function(e){d(a,i,u)});var w=n?-24:24,x=new Konva.Text({x:w,y:e/2-5,text:"",fontSize:10,fontFamily:"sans-serif",fill:"#000",textAlign:"center"});x.hide(),g.label=x;var m=new Image;m.src="http://konvajs.github.io/assets/yoda.jpg";var k=new Konva.Rect({width:s,height:h,fill:t,stroke:t,strokeWidth:1,x:v,y:c,fillPatternImage:m}),p={points:[.5,0,.5,e],strokeWidth:1,stroke:t,x:0,y:0};p.stroke=r?r:t;var y=new Konva.Line(p);return y.show(),k.on("mouseenter",function(e){n&&x.setX(w-x.getWidth()),y.show(),x.show(),a.view.segmentLayer.draw()}),k.on("mouseleave",function(e){y.show(),x.hide(),a.view.segmentLayer.draw()}),g.add(x),g.add(y),g.add(k),g}};module.exports={interpolateHeight:interpolateHeightGenerator,drawWaveform:drawWaveform,waveformDrawFunction:function(e,t){var n=e.intermediateData||e.data,r=interpolateHeightGenerator(e.height-10),o=n.offset_length;drawWaveform(t,n.min,n.max,0,o,r),t.fillStrokeShape(this)},waveformOverviewMarkerDrawFunction:function(e,t,n){t.waveformShape.setPoints([e,0,e,n.height])},niceTime:function(e,t){var n,r,o,a,i=[];n=Math.floor(e%1*100),r=Math.floor(e),o=Math.floor(r/60),a=Math.floor(o/60),a>0&&i.push(a),i.push(o%60),i.push(r%60);for(var u=0;u<i.length;u++){var f=i[u];f<10?i[u]="0"+f:i[u]=f}return i=i.join(":"),t||(n<10&&(n="0"+n),i+="."+n),i},defaultInMarker:function(e){return createHandle(e.height,e.inMarkerColor,!0,e.inlineColor)},defaultOutMarker:function(e){return createHandle(e.height,e.outMarkerColor,!1,e.outlineColor)},defaultPointMarker:function(e){return createPointHandle(e.height,e.pointMarkerColor)},defaultSegmentLabelDraw:function(e){return function(e,t){return new Konva.Text({x:12,y:22,text:t.labelText,fontSize:12,fontFamily:"Arial, sans-serif",fill:"#000",textAlign:"center"})}}};
},{"konva":5}]},{},[15])(15)
});
